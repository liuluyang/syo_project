...
$(document).ready(function() {
	...
	jQuery(".h_10xingbao").slide({
		mainCell: ".bd",
		titCell: ".hd ul li",
		trigger: "click"
	});
	jQuery(".b_banner").slide({
		mainCell: ".bd ul",
		effect: "fold",
		interTime: 5000,
		autoPlay: true
	});
	jQuery(".b_video").slide({
		mainCell: ".bd ul",
		effect: "left",
		autoPlay: true
	});
...
$.fn.extend({
	jscroll: function(a) {
		return this.each(function() {
			...
			c.css({
				height: A,
				background: a.Btn.uBg.Out,
				"background-image": a.BgUrl
			});
			k.css({
				height: A,
				background: a.Btn.dBg.Out,
				"background-image": a.BgUrl
			});
			i.hover(function() {
				if (F == 0) {
			...
			function(I) {
				...
				F = 1;
				i.css({
					background: a.Bar.Bg.Focus,
					"background-image": a.BgUrl
				});
				var H = I.pageY,
				G = parseInt($(this).css("top"));
	...
	mousewheel: function(a) {
		return this.each(function() {
			...
			if ($.browser.msie || $.browser.safari) {
				...
				c.addEventListener("DOMMouseScroll",
				function(d) {
					c.D = d.detail > 0 ? -1 : 1;
					d.preventDefault();
					a && a.call(c)
...
function Ask(a) {
	...
	var c = '<div class="AlertMessage"><div class="MessageTitle"><div class="MessageTitle">' + zb.L("ZB提示您") + '</div><div class="MessageCloseC"><a class="MessageClose" onfocus="this.blur()" href="javascript:Close()" title="关闭">Close</a></div></div><div class="MessageHelp"><div class="Message">' + a.Msg + '</div></div><div class="MessageControl"><div class="MessageControl2"><a onfocus="this.blur()" id="nobackButton_1"  class="noback" onclick="' + a.callback2 + '" href="javascript:Void();"><h4>' + zb.L("取消") + '</h4></a><a onfocus="this.blur()" id="okButton_1" class="ok" onclick="' + a.callback + '" href="javascript:Void();"><h4>' + zb.L("确定") + "</h4></a></div></div></div>";
...
function Ask2(a) {
	...
	var c = '<div class="AlertMessage"><div class="MessageTitle"><div class="MessageTitle">' + zb.L("ZB提示您") + '</div><div class="MessageCloseC"><a class="MessageClose" onfocus="this.blur()" href="javascript:Close()" title="关闭">Close</a></div></div><div class="MessageHelp"><div class="Message">' + a.Msg + '</div></div><div class="MessageControl"><div class="MessageControl2"><a onfocus="this.blur()" id="nobackButton_2"  class="noback" onclick="' + a.callback2 + '" href="javascript:Void();"><h4>' + zb.L("取消") + '</h4></a><a onfocus="this.blur()" id="okButton_2" class="ok" onclick="' + a.callback + '" href="javascript:Void();"><h4>' + zb.L("确定") + "</h4></a></div></div></div>";
	NetBox.show(c, 550, a.Height, a.CloseTime, a.fromObj);
	$("#okButton_2").bind("click",
	function() {
		a.call(a.data);
		return false
	});
...
function Message(c, g, d, a) {
	...
	if (a.CloseTime == 0) {
		e += '<div class="MessageTitle"><div class="MessageTitle">' + a.Tit + '</div><div class="MessageCloseC"><a class="MessageClose" onfocus="this.blur()" href="javascript:Close()" title="关闭">Close</a></div></div>'
	}
	e += '<div class="Message' + a.Style + '"><div class="Message">' + a.Msg + "</div></div>";
	if (a.CloseTime == 0) {
		e += '<div class="MessageControl"><div class="MessageControl2"><a onfocus="this.blur()" id="okButton_2013"  class="ok" onclick="' + a.callback + '" href="javascript:Void();"><h4>' + zb.L("确定") + "</h4></a></div></div>"
	}
	e += "</div>";
...
function Alert(c, a) {
	Message(zb.L("ZB提示您"), c + "", "Alert", a)
}
function Info(c, a) {
	Message(zb.L("ZB提示您"), c + "", "Info", a)
}
function msg(c, a) {
	Message(zb.L("ZB提示您"), c + "", "Info", a)
}
...
function Wrong(c, a) {
	Message(zb.L("ZB提示您"), c + "", "Wrong", a)
}
function Right(c, a) {
	Message(zb.L("ZB提示您"), c + "", "Right", a)
}
function Help(c, a) {
	Message(zb.L("ZB提示您"), c + "", "Help", a)
}
function Iframe(c) {
	var f = {
		Url: "",
	...
	if (c.isShowIframeTitle) {
		...
		if (c.isIframeAutoHeight) {
			d = '<div class="popIframeTitle' + a + '"><div class="popIframeTitle">' + c.Title + '</div><div class="popIframeCloseC"><a class="popIframeClose" onfocus="this.blur()" href="javascript:Close()" title="关闭">Close</a></div></div><div class="popIframeContent"><iframe id="fancybox-frame" name="fancybox-frame' + new Date().getTime() + '" frameborder="0"   hspace="0" ' + ($.browser.msie ? 'allowtransparency="true""': "") + ' scrolling="' + c.scrolling + '" onload="$(this).height($(this).contents().height());NetBox.resize(0,($(this).contents().height()+44));" src="' + c.Url + '"></iframe></div>'
		} else {
			d = '<div class="popIframeTitle' + a + '"><div class="popIframeTitle">' + c.Title + '</div><div class="popIframeCloseC"><a class="popIframeClose" onfocus="this.blur()" href="javascript:Close()" title="关闭">Close</a></div></div><div class="popIframeContent"><iframe id="fancybox-frame" name="fancybox-frame' + new Date().getTime() + '" frameborder="0" hspace="0"  scrolling="' + c.scrolling + '" style="height:' + (c.Height - 44) + 'px"  src="' + c.Url + '"></iframe></div>'
		}
	} else {
		if (c.isIframeAutoHeight) {
...
function EnableRadio(c) {
	...
	a.removeClass("jqTransformRadioEnabled").css({
		cursor: "pointer"
	});
...
function DisenableRadio(c) {
	...
	a.addClass("jqTransformRadioEnabled").css({
		cursor: "default"
	});
	a.unbind("click");
	d.unbind("change")
			...
			if (k) {
				...
				$("#downDiv_" + i).jscroll({
					...
					Bar: {
						...
						Bg: {
							Out: "-51px 0 repeat-y",
							Hover: "-66px 0 repeat-y",
							Focus: "-81px 0 repeat-y"
						}
					},
					Btn: {
						btn: true,
		...
		if (k > n && k <= i) {
			if (jQuery.browser.msie && jQuery.browser.version == "6.0") {
				...
				a.css({
					position: "fixed",
					top: c.offsetY + "px",
					left: (f.offset().left + c.offsetX) + "px"
				})
			}
		} else {
			if (k > i) {
				a.css({
					position: "absolute",
					top: (f.height() - c.offsetY - a.height()) + "px",
					left: c.offsetX + "px"
				})
			} else {
				a.css({
...
$.fn.Loadding = function(a) {
	...
	$(this).fixedIn({
		selecter: "#Lodding_" + f + " .GIF",
		offsetX: a.OffsetXGIF,
		offsetY: a.OffsetYGIF
	})
};
				...
				if (a[d].tagName.toLowerCase() == "select") {
					...
					if (a[d].getAttribute("pattern") != null && a[d].getAttribute("pattern") != undefined && c <= 0) {
						if (!CheckSelect(a[d])) {
							if ($(a[d]).attr("errorName")) {
								currentErrorObj = a[d];
								Wrong("请选择" + $(a[d]).attr("errorName") + "！", {
									callback: "errSelectCalback(" + e + ")"
								})
							} else {
								if (e) {
									$(a[d]).parent().ScrollTo({
	...
	c.prototype = {
		show: function() {
			...
			if (u && this.enabled) {
				...
				case "n":
					r = {
						top: q.top + q.height + this.options.offset,
						left: q.left + q.width / 2 - e / 2
					};
					break;
				case "s":
					...
					r = {
						top: q.top - j - this.options.offset,
						left: q.left + q.width / 2 - e / 2
					};
					break;
				case "e":
					r = {
						top: q.top + q.height / 2 - j / 2,
						left: q.left - e - this.options.offset
					};
					break;
				case "w":
					r = {
						top: q.top + q.height / 2 - j / 2,
						left: q.left + q.width + this.options.offset
					};
					break
				}
				if (y.length == 2) {
			...
			$(window).scroll(function() {
				if (jQuery.browser.msie && jQuery.browser.version == "6.0") {
					...
					n.css({
						position: "fixed",
						top: "0",
						left: q.offset().left - $(window).scrollLeft()
					})
				}
...
function jumpPage(e) {
	...
	if (d > e) {
		Wrong("page number is too large", {
			CloseTime: 1
		});
		return
	}
	if (d < 1) {
		if (d == "") {
			Info("please input page number", {
				CloseTime: 1
			})
		} else {
			Wrong("page number is too small", {
				CloseTime: 1
			})
		}
		return
		...
		if (c.test(d)) {
			...
			Wrong("Page number you entered is not valid, please re-enter.", {
				CloseTime: 1
			})
		}
	}
...
var zb = {
			...
			success: function(k) {
				...
				if (i.dataType == "xml") {
					if ($(k).find("State").text() == "true") {
						if (typeof e.suc == "function") { (function(n) {
								return e.suc(n)
							})(k)
						} else {
						...
						if (typeof e.err == "function") { (function(n) {
								return e.err(n)
							})(k)
						} else {
	...
	user: {
		...
		init: function() {
			...
			if (e.loginStatus) {
				...
				$("#assets").show();
				$("#logOut").show();
				$("#assets .u_name").text(this.showTime() + "，" + a);
				$(".d_menu1 .m2").show();
		...
		showTime: function() {
			var c = new Date();
			var a = c.getHours();
			return a >= 0 && a < 6 ? zb.L("早上好") : a >= 6 && a < 12 ? zb.L("上午好") : a >= 12 && a < 13 ? zb.L("中午好") : a >= 13 && a < 18 ? zb.L("下午好") : zb.L("晚上好")
		},
		firstTitle: "",
		lastP: [0, 0],
		upOrDown: function(a, e, d, c) {
			if (a != 0) {
				return
			}
			if (this.lastP[e] == 0) {
		...
		ticker_deleted: function() {
			var a = this;
			$.getJSON(zb.transDomain + "/line/topall?jsoncallback=?",
			function(c) {
		...
		uticker: function() {
			if (this.isLogin()) {
				var a = this;
				$.getJSON(zb.vipDomain + "/user/userticker?callback=?",
				function(d) {
		...
		zcticker_deleted: function() {
			$.getJSON(zb.vipDomain + "/user/zcticker?callback=?",
			function(c) {
				var a = c.assets;
		...
		resetUserFunds: function() {
			var a = this;
			$.getJSON(zb.vipDomain + "/u/resetUserFunds?callback=?",
			function(c) {
				if (c.isSuc) {
					Right("资金刷新成功", {
						callback: "Close()"
		...
		balance_deleted: function() {
			if (this.isLogin()) {
				$.getJSON(zb.vipDomain + "/u/getBalance?callback=?",
				function(a) {
					var g = a.funds;
	...
	tips: {
		...
		"显示": ["显示", "show"],
		"秒更新": ["秒更新", "s ref"],
		"数据正常更新速度加快为x1秒,可能需要几秒钟生效！": ["数据正常更新速度加快为x1秒,可能需要几秒钟生效！", " Normal data update speed for x1 seconds, may take a few seconds to take effect!"],
		"已经是最快的更新速度了": ["已经是最快的更新速度了", "It was already the fastest speed"],
		"数据正常更新速度减慢为x1秒,可能需要几秒钟生效！": ["数据正常更新速度减慢为x1秒,可能需要几秒钟生效！", "Normal data update at a slower pace for x1 seconds, may take a few seconds to take effect!"],
		"不支持更慢的更新速度": ["不支持更慢的更新速度", "Does not support the renewal speed of slower"],
		"已经是最多的档位显示了": ["已经是最多的档位显示了", "Is one of the most gear shows"],
		"查看": ["查看", "view"],
		"档": ["档", " gear"],
		"数据显示档位调整为x1档,可能需要几秒钟生效！": ["数据显示档位调整为x1档,可能需要几秒钟生效！", "According to gear is adjusted for x1, may take a few seconds to take effect! "],
		"已经是最少的档位显示了": ["已经是最少的档位显示了", "Is the least gears shows"],
		"买": ["买", "bid "],
		"卖": ["卖", "ask "],
		"档位": ["档位", "gear"],
		...
		"已取消": ["已取消", "canceled"],
		"计划中": ["计划中", "in plan"],
		"专业版申请未通过审核，": ["专业版申请未通过审核，", "Professional Edition application is not approved,"],
		"贵宾版申请未通过审核，": ["贵宾版申请未通过审核，", "VIP version of the application is not approved,"],
		"查看原因": ["查看原因", "To see why."],
		"申请专业版": ["申请专业版", "Application VIP Edition"],
		"申请贵宾版": ["申请贵宾版", "Application VIP Edition"],
		"您提交的专业版申请正在审核中，请耐心等待。": ["您提交的专业版申请正在审核中，请耐心等待。", "Professional Edition application is being reviewed your submission, please be patient."],
		"专业版申请中": ["专业版申请中", "Professional Edition application"],
		"您提交的贵宾版申请正在审核中，请耐心等待。": ["您提交的贵宾版申请正在审核中，请耐心等待。", "VIP version of the application is being reviewed your submission, please be patient."],
		"贵宾版申请中": ["贵宾版申请中", "VIP Edition application."],
		"您确定要申请成为专业版用户吗，申请通过后将不能使用大众版？": ["您确定要申请成为专业版用户吗，申请通过后将不能使用大众版？", "Are you sure you want to apply to become a Pro user yet, will not be used by the public version of the application?"],
		"您确定要成为贵宾版用户吗？": ["您确定要成为贵宾版用户吗？", "Are you sure you want to become a VIP version of the user?"],
		...
		"正在买入": ["正在买入", "Buying"],
		"正在卖出": ["正在卖出", "Being sold"],
		"暂时没有符合要求的记录": ["暂时没有符合要求的记录", "Temporarily not conform to the requirements of the record"],
		"请输入X1 X2的单价": ["请输入X1 X2的单价", "Please enter the price of X1 X2"],
		"请输入X1 X2的数量": ["请输入X1 X2的数量", "Please enter the number of X1 X2"],
		"成功取消了X1个委托订单！": ["成功取消了X1个委托订单！", "Success is cancelled X1 commissioned orders! "],
		"您的X1余额：": ["您的X1余额：", "Your X1 balance:"],
		"X1余额：X2，最多可委托：": ["X1余额：X2，最多可委托：", "X1 Balance: X2, up commission:"],
		"成功批量委托X1笔，一共X2个，总金额:": ["成功批量委托X1笔，一共X2个，总金额:", "Successful batch entrust X1, total X2 amount:"],
		"地址已被复制到剪贴板，请核对：": ["地址已被复制到剪贴板，请核对：", "Address has been copied to the clipboard, please check it: "],
		"ZB提示您": ["ZB提示您", "ZB prompts you"],
		"请输入手机号码。": ["请输入手机号码。", "Please enter the phone number."],
		"请输入您的安全密码。": ["请输入您的安全密码。", "Please enter your security code."],
	...
	setLan: function(a) {
		$.getJSON(zb.mainDomain + "/setlan?callback=?&lan=" + a,
		function(c) {
			if (c.isSuc) {
				location.reload()
			}
...
zb.list = {
	...
	aoru: function(f) {
		...
		c = f.width || 560,
		e = f.height || 360,
		d = f.title || "添加/编辑" + this.funcName,
		a = f.scroll || "auto";
		otherParam = f.otherParam || "",
		_this = this,
		url = f.url || _this.basePath + "aoru?id=" + g + otherParam;
		Iframe({
			Url: url,
			Width: c,
			Height: e,
	...
	search: function(c) {
		...
		var q = c.formId || "searchContaint",
		a = c.div || this.defaultDiv,
		g = c.page || 1,
		e = "",
		i = c.special || false,
		n = c.validate || false,
	...
	defaultDiv: "shopslist",
	ajaxPage: function(d, f) {
		...
		zb.ajax({
			...
			suc: function(k) {
				...
				if (typeof d.suc == "function") { (function() {
						d.suc(e)
					} ())
				}
			},
	...
	look: function(f) {
		...
		a = f.width || 820,
		c = f.height || 716,
		g = f.isShowIframeTile == undefined ? true: f.isShowIframeTile,
		i = f.scrolling || "auto",
		e = f.needLogin || false,
		j = this;
...
webSocket.socketConnection = function() {
	var $this = this;
	var targetUrl = "wss://kline." + DOMAIN_BASE + "/websocket";
	if (typeof ZNAME != "undefined") {
		if (ZNAME == "z") {
			targetUrl = "wss://kline." + DOMAIN_BASE + "/websocket"
		} else {
			if (ZNAME == "t") {
				targetUrl = "ws://tkline." + DOMAIN_BASE + ":8580/websocket"
			} else {
				if (ZNAME == "t2") {
					targetUrl = "ws://tkline2." + DOMAIN_BASE + ":8581/websocket"
				} else {
					if (ZNAME == "w") {
						targetUrl = "ws://wkline." + DOMAIN_BASE + ":8580/websocket"
					} else {
						if (ZNAME == "w2") {
							targetUrl = "ws://wkline2." + DOMAIN_BASE + ":8581/websocket"
						}
					}
				}
			}
...
webSocket.dealMessage = function(a) {
	...
	seajs.use(["module_market", "module_asset", "module_user", "module_trans"],
	function(j, f, d, e) {
		if (c.substr(0, 7) == "top_all" || c == "push_user_market") {
			j.getMarketSocket(a)
		} else {
			if (c == "pushLoginData") {
				...
				if (c == "push_user_asset") {
					...
					if (c == "push_user_lever_asset") {
						f.getUserLeverAssetBySocket(a)
					} else {
...
function smallshow() {
	if ($(window).width() < 1200) {
		$(".r-downapp").addClass("small");
		$(".r-downapp span").text("App");
		$("#udesk_btn").addClass("small");
		$("#udesk_btn").hover(function() {
			$(this).removeClass("small")
		},
		function() {
			$(this).addClass("small")
		});
		$(".r-downapp").hover(function() {
			$(this).removeClass("small");
			$(".r-downapp span").text("扫一扫下载APP")
		},
		function() {
			$(this).addClass("small");
			$(".r-downapp span").text("App")
		...
		$(".r-downapp").removeClass("small");
		$(".r-downapp span").text("扫一扫下载APP");
		$("#udesk_btn").removeClass("small");
		$("#udesk_btn,.r-downapp").hover(function() {
			return
		},
		function() {
			$(this).removeClass("small");
