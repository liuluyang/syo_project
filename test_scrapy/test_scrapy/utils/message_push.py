...
import requests
import hashlib
from test_scrapy.settings import  production_mode, appkey, app_master_secret, \
    method, url

#测试数据
device_token_test = 'c95648f602e11d78fb1209652add64f0f1c90ee531168efc4288157c1d301824'
...
class MessagePush(object):
    ...
    def ios_unicast(self, message_info, alert, device_token=None):
        ...
        self._parameter_check(message_info, alert, device_token)
...
if __name__ == '__main__':
    ...
    print (m.ios_listcast(message_info=message_info_list, alert=alert_list))
