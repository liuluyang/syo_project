import sys
sys.path.append('/root/okex_futures_3')
import talib
import numpy as np
import pandas as pd
import json
...
def data_redis(data):
    ...
    if not r.sismember('trans_set_new_3', last_time):
        data = json.dumps(data)
        r.lpush('trans_new_3', data)
        r.sadd('trans_set_new_3', last_time)
...
class SIGNAL(object):
    ...
    def signal(self):
        ...
        # ema_x = ema7 - ema30
        ma5, ma10 = it.MA(data_kline, [7, 30])
        ma_x = ma5 - ma10
